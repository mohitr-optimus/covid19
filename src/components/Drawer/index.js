...
const apiEndpoint = `https://pomber.github.io/covid19/timeseries.json?v=${window.__version__}`;
					...
					>
						...
						>
							...
							<SideInfo
								...
								center={data && data[data.length - 1] && data[data.length - 1].diagnosed}
								downText='diagnosed'
							/>
						</div>
						<div
						...
						>
							...
							<SideInfo
								upText='total of'
								center={data && data[data.length - 1] && data[data.length - 1].recovered}
								downText='recovered'
							/>
							<SideInfo
								upText='with'
								center={
									...
									data[data.length - 1] &&
									`${Math.round(
										(data[data.length - 1].recovered / data[data.length - 1].diagnosed) * 100,
									)}%`
								}
